...
deploy_api() {
  ...
  env_items=(
    ...
    "INKWISE_GROUNDED_MODEL=${INKWISE_GROUNDED_MODEL:-${INKWISE_GEMINI_MODEL:-gemini-3-flash-preview}}"
    "INKWISE_TREEGEN_MODEL=${INKWISE_TREEGEN_MODEL:-${INKWISE_GEMINI_MODEL:-gemini-3-flash-preview}}"
    "INKWISE_QUERY_REWRITE_MODEL=${INKWISE_QUERY_REWRITE_MODEL:-${INKWISE_GEMINI_MODEL:-gemini-3-flash-preview}}"
    "INKWISE_TREE_SEARCH_MODEL=${INKWISE_TREE_SEARCH_MODEL:-${INKWISE_GEMINI_MODEL:-gemini-3-flash-preview}}"
