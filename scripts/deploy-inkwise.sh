...
deploy_api() {
  ...
  env_items=(
    ...
    "INKWISE_GEMINI_MODEL=${INKWISE_GEMINI_MODEL:-gemini-3.1-pro-preview}"
    "INKWISE_GROUNDED_MODEL=${INKWISE_GROUNDED_MODEL:-${INKWISE_GEMINI_MODEL:-gemini-3.1-pro-preview}}"
    "INKWISE_TREEGEN_MODEL=${INKWISE_TREEGEN_MODEL:-${INKWISE_GEMINI_MODEL:-gemini-3.1-pro-preview}}"
    "INKWISE_QUERY_REWRITE_MODEL=${INKWISE_QUERY_REWRITE_MODEL:-${INKWISE_GEMINI_MODEL:-gemini-3.1-pro-preview}}"
    "INKWISE_TREE_SEARCH_MODEL=${INKWISE_TREE_SEARCH_MODEL:-${INKWISE_GEMINI_MODEL:-gemini-3.1-pro-preview}}"
