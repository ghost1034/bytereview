...
ARG NEXT_PUBLIC_ACCOUNTINGCLAW_IMAGE
ARG NEXT_PUBLIC_LEGALCLAW_IMAGE
ARG NEXT_PUBLIC_TASKLYTIC_BACKEND=1
ARG NEXT_PUBLIC_FILE_STORAGE_ADAPTER=object_store
...
ENV NEXT_PUBLIC_ACCOUNTINGCLAW_IMAGE=$NEXT_PUBLIC_ACCOUNTINGCLAW_IMAGE
ENV NEXT_PUBLIC_LEGALCLAW_IMAGE=$NEXT_PUBLIC_LEGALCLAW_IMAGE
ENV NEXT_PUBLIC_TASKLYTIC_BACKEND=$NEXT_PUBLIC_TASKLYTIC_BACKEND
ENV NEXT_PUBLIC_FILE_STORAGE_ADAPTER=$NEXT_PUBLIC_FILE_STORAGE_ADAPTER
