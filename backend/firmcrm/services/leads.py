...
from firmcrm.models import Account, Contact, Lead, Opportunity, Pipeline, User, utcnow
from firmcrm.schemas import FirmCrmLeadConvertIn
...
def convert(db: Session, lead: Lead, body: FirmCrmLeadConvertIn, actor: User) -> tuple[Account, Contact, Opportunity | None]:
