...
from firmcrm.models import Account, Contact, Lead, Opportunity, PracticeArea, Stage, User, utcnow
...
def archive(db: Session, obj, actor_id: str, entity_type: str) -> None:
    if obj.is_archived:
...
def restore(db: Session, obj, actor_id: str, entity_type: str) -> None:
