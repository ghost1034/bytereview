...
const FAQS = [
  ...
  },
  {
    ...
    a: 'CPAAutomation includes Universal Document Analysis (extraction & automations), Form Fill, Inkwise (AI writing with grounded citations), the AI Project Management (project management, team coordination, time, forms & reporting), E-Signature, Chrona (time tracking), the Claw Series of AI digital workers, the AI Analytics Suite (variance, reconciliation, fixed assets, waterfalls & research bots), and a free CPE Tracker.',
  },
]
