...
export function JobsPage() {
  ...
  const filteredJobs = jobs.filter(job =>
    (job.name || `Job ${job.id}`).toLowerCase().includes(searchQuery.toLowerCase())
  )
      ...
      <AlertDialog open={!!deleteJobId} onOpenChange={() => setDeleteJobId(null)}>
        <AlertDialogContent>
          <AlertDialogHeader>
            ...
            <AlertDialogDescription>
              Are you sure you want to delete this job? This action cannot be undone and will permanently delete all associated files and results.
            </AlertDialogDescription>
          </AlertDialogHeader>
          <AlertDialogFooter>
