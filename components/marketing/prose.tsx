  ...
  return (
    <div
      className={cn(
        ...
        'prose-code:bg-surface-muted prose-code:text-foreground prose-code:rounded prose-code:px-1.5 prose-code:py-0.5 prose-code:font-mono prose-code:text-sm prose-code:font-normal prose-code:before:content-none prose-code:after:content-none',
        'prose-pre:bg-surface-muted prose-pre:border prose-pre:border-border prose-pre:text-foreground prose-pre:rounded-lg',
