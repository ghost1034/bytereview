...
export default function Shell({ children }: { children: ReactNode }) {
  ...
  return <div className="flex min-h-[75vh] min-w-0 flex-col lg:flex-row">
    <aside className="w-full shrink-0 border-b border-crm-sand-150 p-3 lg:w-[210px] lg:border-b-0 lg:border-r">
