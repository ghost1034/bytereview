...
export function useFocusTrap(open: boolean, panel: RefObject<HTMLElement | null>, opts: { onClose: () => void; initialFocus?: RefObject<HTMLElement | null>; closeButton?: RefObject<HTMLElement | null> }) {
