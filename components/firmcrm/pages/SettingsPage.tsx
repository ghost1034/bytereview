...
function BusinessRules() {
  ...
  return <Card title="Business rules"><form className="max-w-lg space-y-4" onSubmit={async e=>{e.preventDefault();setSaving(true);try { await patch('/settings',draft);toast('Settings saved') } catch(e) { error(e) } finally { setSaving(false) }}}>
