        ...
        <div className="flex justify-between items-center h-16">
          <div className="flex items-center space-x-8">
            ...
            <div className="hidden md:flex space-x-6">
              {user ? (
                <Link href="/dashboard" className={`text-gray-700 hover:text-lido-blue transition-colors ${location === '/dashboard' ? 'text-lido-blue' : ''}`}>
                  Dashboard
                </Link>
              ) : (
                <Link href="/demo" className={`text-gray-700 hover:text-lido-blue transition-colors ${location === '/demo' ? 'text-lido-blue' : ''}`}>
                  Try it
                </Link>
              )}
              <Link href="/pricing" className={`text-gray-700 hover:text-lido-blue transition-colors ${location === '/pricing' ? 'text-lido-blue' : ''}`}>
                Pricing
              </Link>
              <Link href="/features" className={`text-gray-700 hover:text-lido-blue transition-colors ${location === '/features' ? 'text-lido-blue' : ''}`}>
                Features
              </Link>
            </div>
          </div>
