      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-gray-600">
            How we protect and handle your data at Financial Extract
          </p>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-gray-700 mb-4">
                    At Financial Extract, we understand that your documents contain sensitive financial and legal information. 
          ...
          <Card className="bg-red-50 border-red-200">
            <CardContent className="p-8">
              ...
              <p className="text-gray-700 mb-6">
                Financial Extract does not sell, rent, or trade your personal information or document data to third parties 
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <div className="space-y-2 text-gray-600">
                    <p>Email: privacy@financialextract.com</p>
          ...
          <Card>
            <CardContent className="p-8">
              ...
              <p className="text-gray-600">
                ...
                by email and by posting the updated policy on our website. Your continued use of Financial Extract 
