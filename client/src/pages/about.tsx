    ...
    <div className="min-h-screen py-20">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-16">
          <h1 className="text-5xl font-bold text-gray-900 mb-6">About Financial Extract</h1>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lg text-gray-600 mb-6">
                Financial Extract was created to bridge the gap between traditional document processing and modern AI capabilities. 
        ...
        <section className="text-center bg-gray-50 rounded-lg p-12">
          ...
          <p className="text-lg text-gray-600 mb-6">
            Connect with our team to learn more about how Financial Extract can transform your document processing workflow.
          </p>
