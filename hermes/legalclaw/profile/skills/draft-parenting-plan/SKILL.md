...
metadata:
  hermes:
    ...
    category: legal
    source_task: trusts-estates-private-client/draft-parenting-plan
...
2. Triage the child-centered facts.
...
3. Draft the residential architecture.
...
4. Draft decision-making provisions.
...
5. Draft protections and contingency terms.
...
6. Draft the dispute-resolution sequence.
...
7. Draft the future-modification and relocation language.
