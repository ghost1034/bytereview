...
metadata:
  hermes:
    ...
    category: legal
    source_task: white-collar-defense-investigations/draft-response-to-sec-wells-notice
...
# Skill: Draft Response to SEC Wells Notice — Investment Adviser Wells Submission
