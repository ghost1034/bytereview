...
metadata:
  hermes:
    ...
    category: legal
    source_task: trusts-estates-private-client/identify-settlement-proposal-issues/scenario-01
...
1. Enumerate the relevant issues or categories first; if only one item is truly in scope, say so and explain why.
2. Identify the controlling source documents for the point: settlement proposal, financial disclosure, valuation materials, parenting terms, tax assumptions, or release language.
3. State the governing rule or convention with a named authority where possible.
4. Compare the proposal to the record using the disclosed inputs, and quantify the discrepancy if the record supports arithmetic.
5. Cross-check against any other clause, schedule, disclosure, or exhibit that changes the analysis.
6. State the downstream consequence for the client: economic, support, tax, enforcement, litigation, or drafting risk.
7. Give a counter-position or revision recommendation that is concrete and usable in negotiation.
