...
export function buildStarterContent(input: ProvisionInput): ProvisionResult {
  ...
  const project: Project = {
    ...
    description: '<p>Welcome to CPAAutomation Project Management — your home for projects and tasks.</p>',
    iconEmoji: '🚀',
    color: 'primary',
  ...
  const notification: Notification = {
    ...
    message: 'Welcome to Project Management — open your starter project to begin.',
    unread: true,
    archived: false,
    createdAt: now(),
  }
  ...
  const goal: Goal = {
    id: newId(),
    workspaceId,
    name: 'Launch Project Management successfully',
