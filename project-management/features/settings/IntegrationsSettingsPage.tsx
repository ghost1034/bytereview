...
export function IntegrationsSettingsPage() {
  ...
  return <div className="space-y-4">
    <div><h1 className="font-serif text-2xl">Production integrations</h1><p className="text-sm" style={{ color: 'var(--ink-muted)' }}>Only providers supported by AI Project Management are listed. Workspace-plan billing remains under Workspace Billing and is not a client-payment integration.</p></div>
