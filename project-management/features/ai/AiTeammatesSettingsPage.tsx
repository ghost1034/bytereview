...
export function AiTeammatesSettingsPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="flex items-center gap-2 font-sans text-2xl"><Bot className="h-5 w-5" /> AI teammates</h1>
      ...
      {message ? <p role="status" className="text-sm" style={{ color: 'hsl(var(--foreground-muted))' }}>{message}</p> : null}
    </div>
  )
}
