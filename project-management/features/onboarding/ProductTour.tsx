  ...
  return (
    <GuidedTour
      ...
      overlayProps={{
        ...
        highlightClassName: 'rounded-lg border-0 bg-transparent shadow-none ring-2 ring-ring',
        panelClassName: ' max-h-[calc(100vh-2rem)] overflow-y-auto',
        primaryButtonClassName: 'border-0 bg-primary text-primary-foreground hover:bg-primary/90',
        highlightPadding: 4,
        panelWidth: 400,
        panelHeight: 300,
        gap: 12,
